...
$(TARGET_PROG_01) : $(SRC_DIR)/prog_ftest.F03 \
                    $(TARGET_LIB) 
	$(FC) $(FC_FLAGS) $(INC_FLAGS) -o $@ $(SRC_DIR)/prog_ftest.F03 $(LIB_FLAGS)
	
$(TARGET_LIB) : $(OBJ_LIST) 
	$(AR) $(ARFLAGS) $@ $(OBJ_LIST) 

$(OBJ_DIR)/mod_ftest.o : $(SRC_DIR)/mod_ftest.F03  
	$(FC) $(FC_FLAGS) $(INC_FLAGS) -c -o $@ $(SRC_DIR)/mod_ftest.F03
